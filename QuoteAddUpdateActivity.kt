...
import com.sehatin.ittp.Helper.ALERT_DIALOG_CLOSE
import com.sehatin.ittp.Helper.ALERT_DIALOG_DELETE
...
import com.sehatin.ittp.databinding.ActivityQuoteAddUpdateBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isEdit) {
            ...
            quote?.let {
                ...
                binding.edtDescription.setText(it.descriptions)
            }
        } else {
